...
StackPointer undirected_stack_init() {                      /* Create a stack and return it */
    StackPointer S = malloc(sizeof(*S));
    S->ItemList = NULL;
    return S;
}

int undirected_stack_empty(StackPointer S) {        /* Check if the stack is empty */
    return (S->ItemList == NULL);
}

void undirected_stack_push(int Item, StackPointer S) {                     /* Push an item to the stack */
...
int undirected_stack_pop(StackPointer S) {                                                     /* Pop the first item from the stack */
    if (S->ItemList == NULL) {
